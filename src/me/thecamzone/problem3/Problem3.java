...
public class Problem3 {
  ...
  public void setAmountMade(int cornAmount, int cucumberAmount, int milkAmount, int cheeseAmount, int baconAmount, int hamAmount) {
  ...
  public void setAmountConsumed(int cornAmount, int cucumberAmount, int milkAmount, int cheeseAmount, int baconAmount, int hamAmount) {
  ...
  public void generateReport() {
    ...
    System.out.println(String.valueOf(this.CUCUMBER.getName()) + " left over: " + this.CUCUMBER.getAmountLeftOver());
    System.out.println();
